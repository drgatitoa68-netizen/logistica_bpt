  ...
  const modules = [
    {
      ...
      icon: "⬡",
      label: "ANÁLISIS BPT",
      desc: "Sube Excel, visualiza el mapa de planta y procesa líneas de producción directamente",
      color: "#2563eb",
    ...
    },
    {
      ...
      desc: "Ver tareas asignadas y actualizar su estado en tiempo real",
      color: "#7c3aed",

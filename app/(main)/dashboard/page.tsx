  ...
  const modules = [
    {
      ...
      icon: "⬡",
      label: "ANÁLISIS BPT",
      desc: "Sube Excel, visualiza el mapa de planta y envía líneas a revisión del supervisor",
      color: "#2563eb",
    ...
    },
    {
      ...
      desc: "Revisa y aprueba las líneas pendientes antes de enviarlas a los operadores",
      color: "#f97316",
    ...
    },
    {
      ...
      desc: "Ver tareas aprobadas y actualizar su estado en tiempo real",
      color: "#7c3aed",
...
const s: { [k: string]: React.CSSProperties } = {
  ...
  card:      { background: "#ffffff", border: "1px solid", borderRadius: 8, padding: "28px 24px", display: "flex", flexDirection: "column", gap: 10, cursor: "pointer", transition: "box-shadow 0.2s", minHeight: 160, boxShadow: "0 1px 3px rgba(0,0,0,0.06)" },

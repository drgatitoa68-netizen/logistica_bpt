...
const s: { [k: string]: React.CSSProperties } = {
  root: { padding: "32px", fontFamily: "'Courier New', monospace", color: "#1e293b", minHeight: "100vh", background: "#f1f5f9" },
  ...
  title: { margin: "0 0 6px", fontSize: 26, fontWeight: 700, color: "#0f172a", letterSpacing: 1 },
  ...
  dropTitle: { fontSize: 16, fontWeight: 700, color: "#0f172a", letterSpacing: 1 },
  ...
  resultBox: { marginTop: 20, background: "#ffffff", border: "1px solid rgba(34,197,94,0.3)", borderRadius: 4, padding: "20px 24px", display: "flex", flexDirection: "column", gap: 8 },
  ...
  guideBox: { background: "#ffffff", border: "1px solid rgba(249,115,22,0.3)", borderRadius: 4, padding: "20px 24px" },
  guideTitle: { fontSize: 10, letterSpacing: 3, color: "#f97316", marginBottom: 16 },
  guideSection: { marginBottom: 16 },
  guideLabel: { fontSize: 12, fontWeight: 700, color: "#1e293b", marginBottom: 8 },
  guideList: { margin: 0, padding: "0 0 0 18px", display: "flex", flexDirection: "column", gap: 5 },
  logBox: { background: "#ffffff", border: "1px solid rgba(249,115,22,0.25)", borderRadius: 4, padding: "16px 20px" },
